...
//    }else{
 ...
 //   }
    ...
    do{
        ...
        p[0].tScore == 26 ? p[0].tScore = 0, p[1].tScore = 26, p[2].tScore = 26, p[3].tScore = 26,cout << "Hey, Wiseguy! You shot the moon! The Stooges takes all points." << endl << endl :
        p[1].tScore == 26 ? p[1].tScore = 0, p[2].tScore = 26, p[3].tScore = 26, p[0].tScore = 26, cout << "Larry shot the moon! The rest of you schmucks can take the points."  << endl << endl :
        p[2].tScore == 26 ? p[2].tScore = 0, p[3].tScore = 26, p[0].tScore = 26, p[1].tScore = 26, cout << "Curly shot the moon! The rest of you schmucks can take the points."  << endl << endl :
        p[3].tScore == 26 ? p[3].tScore = 0, p[0].tScore = 26, p[1].tScore = 26, p[2].tScore = 26, cout << "Moe shot the moon! The rest of you schmucks can take the points."  << endl << endl :    
